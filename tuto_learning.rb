...
BASE_URL = 'http://tutolearning.com' # http://avaxsearch.com/avaxhome_search?q=sex&commit=Go
PAGE_COUNT = 20

FILENAME = 'tutolearning_search.txt'
...
url = "#{BASE_URL}/search/#{search_keyword}"
...
(1..PAGE_COUNT).each do |page_count|
  ...
  next_page = page.css("div#page-nav a.next").first 
